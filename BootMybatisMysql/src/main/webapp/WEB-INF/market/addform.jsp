		...
		<caption>상품정보 입력</caption>
			<tr>
			 <th bgcolor="#ffccc">상품명</th>
			 	<td>
			 	<input type="text" name="sang" class="form-control" style="width: 300px;" required="required">
			 	</td>
			</tr>
			...
			<tr>
			 <th bgcolor="#ffccc">단가</th>
			 	<td>
			 	<input type="text" name="dan" class="form-control" style="width: 300px;" required="required">
			 	</td>
			</tr>
